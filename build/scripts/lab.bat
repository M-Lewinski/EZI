...
set CLASSPATH=%APP_HOME%\lib\lab-1.0-SNAPSHOT.jar;%APP_HOME%\lib\jcommander-1.72.jar

@rem Execute lab
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB_OPTS%  -classpath "%CLASSPATH%" com.lab1.Main %CMD_LINE_ARGS%
